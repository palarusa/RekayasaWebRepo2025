...
Route::middleware('auth')->group(function() {
    ...
    //Route::get('/', [PageController::class, 'dashboardOverview1''dashboard-overview-1');

   
    Route::get('/dashboard/create', [DashboardController::class, 'create'])->name('dashboardcreate');
    Route::post('/dashboard/create', [DashboardController::class, 'store'])->name('dashboardstore');
    Route::get('/dashboard/edit/{id}', [DashboardController::class, 'edit'])->name('dashboardedit');
    Route::put('/dashboard/update/{id}', [DashboardController::class, 'update'])->name('dashboardupdate');
    Route::delete('/dashboard/destroy/{id}', [DashboardController::class, 'destroy'])->name('dashboardestroy');
